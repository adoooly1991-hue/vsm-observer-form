...
def export_observations_pptx(observations_df, out_path, steps=None, perstep_top2=None, spacing_mode="Effective CT", ct_eff_map=None):
    ...
    # Thematic (PQCDSM) slides
    add_pqcdsm_slides(prs, observations_df)
...
def add_pqcdsm_slides(prs, observations_df):
    theme_order = [("P","Production"),("Q","Quality"),("C","Cost"),("D","Delivery"),("S","Safety"),("M","Morale")]
    # Prepare theming columns if missing
    ...
    for code, name in theme_order:
        ...
        title.text_frame.text = f"{code} — {name}: Observations"
